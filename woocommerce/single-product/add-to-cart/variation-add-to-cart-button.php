...
?>
<div class="woocommerce-variation-add-to-cart variations_button product-details__actions">
	...
	<button type="submit" class="btn-primary product-details__actions-cart ajax_add_to_cart">
