		...
		>
			...
			<tr>
				...
				foreach ( $items as $item_id => $item ) :
					...
					$wait_product_id = wc_get_order_item_meta( $item_id, 'wait-product');
					$wait_product = false;
					if($wait_product_id){
						$wait_product = wc_get_product($wait_product_id);
					}
					?>
					<!-- ITEM begin -->
					<tr>
						...
						>
							...
							<tr>
								...
								<table width="88" border="0" cellspacing="0" cellpadding="0" style="max-width: 88px;width: 88px;">
									...
									<td>
										<a 
										href="<?php echo $wait_product ? $wait_product->get_permalink() : $product->get_permalink();?>" 
										target="_blank" 
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									...
									>
										...
										><?php echo $product->get_title();?> <?php if($wait_product) echo "for product: " . $wait_product->get_title();?></a>
									</td>
									</tr>  
									<tr>
									<td 
