    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%" class="wrapper">
        ...
        >
            ...
            <tr>
                ...
                >
                You contributed <b><?php echo $amount;?> credits</b> to the <b><?php echo $campaign->post_title;?>.</b>
                </td>
            </tr>
            <tr>
                <td 
                ...
                style="padding: 8px 0px 0px 0px;font-family: Helvetica, Arial, sans-serif; color: #1D3557; font-size: 16px;line-height: 24px;font-weight: normal;"
                >
                When goal will be achieved you will get an email notification about it!
                </td>
            </tr>
            <tr>
                <td 
