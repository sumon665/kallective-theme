                    ...
                    >
                      <table border="0" cellpadding="0" cellspacing="0" width="100%" class="wrapper">
                        ...
                        <tr>
                          ...
                          >
                            Use this in a checkout step to get a discount!
                          </td>
                        </tr>
                        <tr>
                          <td 
                          ...
                          >
                            <table width="288" border="0" cellspacing="0" cellpadding="0" style="width: 100%; max-width: 288px;">
                              <tr>
                                <td 
                                  align="center" 
                                  valign="top" 
                                  style="padding: 15px 0px 15px 0px;font-family: Helvetica, Arial, sans-serif; color: #1D3557; font-size: 24px;line-height: 32px;font-weight: normal;border: 1px solid #1D3557;border-radius: 4px;"
                                >
                                <?php echo $coupon; ?>
                                </td>
                              </tr>
