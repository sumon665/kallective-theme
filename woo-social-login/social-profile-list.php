					...
					<tr>
						...
						<td data-title="<?php esc_html__( 'Provider', 'wooslg' ); ?>">
							<div class="woo-slg-provider <?php echo $profile; ?>">
								<span class="woo-slg-provider-icon"><img src="<?php echo esc_url($provider_icon); ?>"></span><span class="woo-slg-provider-name"><?php echo ($profile == 'googleplus') ? 'google' : $profile ; ?></span>
							</div>
						</td>
